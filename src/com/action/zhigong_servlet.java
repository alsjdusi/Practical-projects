...
public class zhigong_servlet extends HttpServlet
{
	...
	{
		String sql1="update t_zhigong set del='yes' where id="+Integer.parseInt(req.getParameter("id"));
		String sql2 = "delete from t_gongzi ta where ta.zhigong_id in (SELECT id FROM t_zhigong WHERE del = 'yes')";
		Object[] params={};
		DB mydb=new DB();
